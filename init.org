...
** Clojure
   ...
   #+BEGIN_SRC emacs-lisp
     (evil-define-key '(normal visual) clojure-mode-map
       "cpc"  'cider-connect ;; "connect"
       "cps"  'cider-jack-in ;; "start"
     ...
     (evil-define-key '(normal visual) cider-mode-map
       ...
       "clf"  'cider-load-file
       "cla"  'cider-load-all-files
       "clp"  'cider-load-all-project-ns
       "ctn"  'emidje-run-ns-tests
       "ctp"  'emidje-run-all-tests
       "ctr"  'emidje-re-run-non-passing-tests
       "cts"  'emidje-show-test-report
       "ctt"  'emidje-run-test-at-point
     ...
     (evil-leader/set-key-for-mode 'clojure-mode
       "crc" 'hydra-cljr-code-menu/body
       "crh" 'hydra-cljr-help-menu/body
       "crn" 'hydra-cljr-ns-menu/body
       "crp" 'hydra-cljr-project-menu/body
       "crt" 'hydra-cljr-toplevel-menu/body)
   #+END_SRC
